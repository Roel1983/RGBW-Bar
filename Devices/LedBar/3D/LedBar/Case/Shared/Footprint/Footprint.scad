...
module Footprint(
    ...
    if(footprint[0] == "RGBW-Bar") {
        ...
        if(footprint[1] == "PinHeader_1x05_P2.54mm_Horizontal") {
            Footprint__Connector_PinHeader_2_54mm__PinHeader_1x_P2_54mm_Horizontal(layer = layer, pins = 5);
        }
    }
}
...
module Footprint__RGBW_Bar(
    layer,
    footprint
) {
    if(footprint == "perpendicular_pcb_1mm_female_2x6") {
        Footprint__RGBW_Bar__perpendicular_pcb_1mm_female_2x6(layer);
    } else if(footprint == "MountingHole_4.3mm_M4_modified1") {
        Footprint(layer = layer, ["MountingHole", "MountingHole_4.3mm_M4"]); // TODO doesn't show
        ...
        Footprint__RGBW_Bar__15EDGRC_3_5(layer = layer, pins = 2);
    } else if(footprint == "15EDGRC-3.5-3P") {
        Footprint__RGBW_Bar__15EDGRC_3_5(layer = layer, pins = 3);
    } else if(footprint == "2EDGRC-5.08-2P") {
        Footprint__RGBW_Bar__2EDGRC_5_08_2P(layer = layer, pins = 2);
    }
}
...
module Footprint__RGBW_Bar__15EDGRC_3_5(layer = "3D", pins) {
    if (layer == "3D") {
        pitch = mm(3.5);
        a     = (pins - 1) * pitch;
        b     = mm(4.4);
...
module Footprint__RGBW_Bar__2EDGRC_5_08_2P(layer = "3D", pins = 2) {
    if (layer == "3D") {
        pitch = inch(0.20);
        a     = (pins - 1) * pitch;
        b     = mm(5.2);
...
module Footprint__MountingHole(layer, footprint) {
    if(footprint == "MountingHole_4.3mm_M4") {
...
module Footprint__Connector_PinHeader_2_54mm__PinHeader_1x_P2_54mm_Horizontal(
    layer = "3D",
    pins = 5
) {
    if (layer == "3D") {
